...
/**
 * Creates a new action group that replaces 'Exporting' group in the toolbar.
...
export const replaceExportingGroup = (builder: ExtensionBuilder) => {
    ...
    builder.activitiesExplorer.table.toolbar.replaceGroup(activitiesExplorerActionGroupId.exporting, {
        id: 'newGroup',
