...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/color-picker-field'),
        publicPath: `${extensionsRequestBasePath}/color-picker-field/dist/color-picker-field`,
        clean: true,
    },
