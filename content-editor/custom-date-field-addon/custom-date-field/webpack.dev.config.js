...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/custom-date-field'),
        publicPath: `${extensionsRequestBasePath}/custom-date-field/dist/custom-date-field`,
        clean: true,
    },
