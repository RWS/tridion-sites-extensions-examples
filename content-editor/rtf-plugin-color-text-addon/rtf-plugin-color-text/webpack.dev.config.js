...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/rtf-plugin-color-text'),
        publicPath: `${extensionsRequestBasePath}/rtf-plugin-color-text/dist/rtf-plugin-color-text`,
        clean: true,
    },
