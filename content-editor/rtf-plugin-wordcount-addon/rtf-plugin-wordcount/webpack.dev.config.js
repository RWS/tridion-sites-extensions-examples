...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/rtf-plugin-wordcount'),
        publicPath: `${extensionsRequestBasePath}/rtf-plugin-wordcount/dist/rtf-plugin-wordcount`,
        clean: true,
    },
