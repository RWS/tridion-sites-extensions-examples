...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/rtf-remove-single-line-wrapping-paragraph'),
        publicPath: `${extensionsRequestBasePath}/rtf-remove-single-line-wrapping-paragraph/dist/rtf-remove-single-line-wrapping-paragraph`,
        clean: true,
    },
