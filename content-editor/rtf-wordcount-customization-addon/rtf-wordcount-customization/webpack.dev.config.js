...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/rtf-wordcount-customization'),
        publicPath: `${extensionsRequestBasePath}/rtf-wordcount-customization/dist/rtf-wordcount-customization`,
        clean: true,
    },
