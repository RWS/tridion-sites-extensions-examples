...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/switch-language-action'),
        publicPath: `${extensionsRequestBasePath}/switch-language-action/dist/switch-language-action`,
        clean: true,
    },
