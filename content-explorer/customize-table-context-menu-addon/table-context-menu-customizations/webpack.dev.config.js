...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/table-context-menu-customizations'),
        publicPath: `${extensionsRequestBasePath}/table-context-menu-customizations/dist/table-context-menu-customizations`,
        clean: true,
    },
