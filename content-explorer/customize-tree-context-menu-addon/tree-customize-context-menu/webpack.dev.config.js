...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/tree-customize-context-menu'),
        publicPath: `${extensionsRequestBasePath}/tree-customize-context-menu/dist/tree-customize-context-menu`,
        clean: true,
    },
