...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/published-to-column'),
        publicPath: `${extensionsRequestBasePath}/published-to-column/dist/published-to-column`,
        clean: true,
    },
