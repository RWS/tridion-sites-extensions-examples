...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/schema-purpose-column'),
        publicPath: `${extensionsRequestBasePath}/schema-purpose-column/dist/schema-purpose-column`,
        clean: true,
    },
