...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/confirm-say-hello-notification-action'),
        publicPath: `${extensionsRequestBasePath}/confirm-say-hello-notification-action/dist/confirm-say-hello-notification-action`,
        clean: true,
    },
