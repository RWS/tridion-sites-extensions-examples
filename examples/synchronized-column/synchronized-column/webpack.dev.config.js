...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/extension-example'),
        publicPath: `${extensionsRequestBasePath}/extension-example/dist/extension-example`,
        clean: true,
    },
