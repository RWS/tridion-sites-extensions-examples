...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/customize-navigation'),
        publicPath: `${extensionsRequestBasePath}/customize-navigation/dist/customize-navigation`,
        clean: true,
    },
