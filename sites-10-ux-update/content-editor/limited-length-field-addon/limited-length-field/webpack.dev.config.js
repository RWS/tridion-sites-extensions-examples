...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/limited-length-field'),
        publicPath: `${extensionsRequestBasePath}/limited-length-field/dist/limited-length-field`,
        clean: true,
    },
