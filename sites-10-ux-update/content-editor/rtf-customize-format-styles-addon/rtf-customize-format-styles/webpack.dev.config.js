...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/rtf-customize-format-styles'),
        publicPath: `${extensionsRequestBasePath}/rtf-customize-format-styles/dist/rtf-customize-format-styles`,
        clean: true,
    },
