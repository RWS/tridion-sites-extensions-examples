...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/change-language-action'),
        publicPath: `${extensionsRequestBasePath}/change-language-action/dist/change-language-action`,
        clean: true,
    },
