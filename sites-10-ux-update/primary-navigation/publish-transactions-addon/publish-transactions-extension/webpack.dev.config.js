...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/publish-transactions-extension'),
        publicPath: `${extensionsRequestBasePath}/publish-transactions-extension/dist/publish-transactions-extension`,
        clean: true,
    },
