...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/prevent-folder-publishing'),
        publicPath: `${extensionsRequestBasePath}/prevent-folder-publishing/dist/prevent-folder-publishing`,
        clean: true,
    },
