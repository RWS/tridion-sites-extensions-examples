...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/archived-item-confirmation'),
        publicPath: `${extensionsRequestBasePath}/archived-item-confirmation/dist/archived-item-confirmation`,
        clean: true,
    },
