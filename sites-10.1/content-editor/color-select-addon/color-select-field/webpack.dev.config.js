...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/color-select-field'),
        publicPath: `${extensionsRequestBasePath}/color-select-field/dist/color-select-field`,
        clean: true,
    },
