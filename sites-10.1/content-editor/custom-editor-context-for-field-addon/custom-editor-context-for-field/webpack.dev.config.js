...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/custom-editor-context-for-field'),
        publicPath: `${extensionsRequestBasePath}/custom-editor-context-for-field/dist/custom-editor-context-for-field`,
        clean: true,
    },
