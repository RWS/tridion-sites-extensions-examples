...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/editor-multiselect-field'),
        publicPath: `${extensionsRequestBasePath}/editor-multiselect-field/dist/editor-multiselect-field`,
        clean: true,
    },
