...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/add-favorites-management-actions'),
        publicPath: `${extensionsRequestBasePath}/add-favorites-management-actions/dist/add-favorites-management-actions`,
        clean: true,
    },
