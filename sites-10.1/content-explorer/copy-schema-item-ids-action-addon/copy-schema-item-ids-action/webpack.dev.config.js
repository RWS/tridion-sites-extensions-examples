...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/copy-schema-item-ids-action'),
        publicPath: `${extensionsRequestBasePath}/copy-schema-item-ids-action/dist/copy-schema-item-ids-action`,
        clean: true,
    },
