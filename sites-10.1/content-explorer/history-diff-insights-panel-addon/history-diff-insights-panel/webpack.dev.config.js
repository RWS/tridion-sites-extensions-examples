...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/history-diff-insights-panel'),
        publicPath: `${extensionsRequestBasePath}/history-diff-insights-panel/dist/history-diff-insights-panel`,
        clean: true,
    },
