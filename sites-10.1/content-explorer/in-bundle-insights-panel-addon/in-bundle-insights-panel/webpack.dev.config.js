...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/in-bundle-insights-panel'),
        publicPath: `${extensionsRequestBasePath}/in-bundle-insights-panel/dist/in-bundle-insights-panel`,
        clean: true,
    },
