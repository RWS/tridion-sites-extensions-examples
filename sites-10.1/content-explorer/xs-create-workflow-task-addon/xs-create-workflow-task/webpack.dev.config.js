...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/xs-create-workflow-task'),
        publicPath: `${extensionsRequestBasePath}/xs-create-workflow-task/dist/xs-create-workflow-task`,
        clean: true,
    },
