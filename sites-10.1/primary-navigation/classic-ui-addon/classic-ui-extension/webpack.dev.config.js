...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/classic-ui-extension'),
        publicPath: `${extensionsRequestBasePath}/classic-ui-extension/dist/classic-ui-extension`,
        clean: true,
    },
