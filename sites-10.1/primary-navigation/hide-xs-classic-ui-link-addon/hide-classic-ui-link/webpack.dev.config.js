...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/hide-classic-ui-link'),
        publicPath: `${extensionsRequestBasePath}/hide-classic-ui-link/dist/hide-classic-ui-link`,
        clean: true,
    },
