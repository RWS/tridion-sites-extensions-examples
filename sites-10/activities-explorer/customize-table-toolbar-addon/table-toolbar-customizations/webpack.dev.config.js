...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/table-toolbar-customizations'),
        publicPath: `${extensionsRequestBasePath}/table-toolbar-customizations/dist/table-toolbar-customizations`,
        clean: true,
    },
