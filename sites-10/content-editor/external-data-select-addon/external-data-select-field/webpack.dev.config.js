...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/external-data-select-field'),
        publicPath: `${extensionsRequestBasePath}/external-data-select-field/dist/external-data-select-field`,
        clean: true,
    },
